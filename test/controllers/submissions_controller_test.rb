...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { title: @submission.title, body: @submission.body }}
    end
  ...
  test "should edit submission" do
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { title: @submission.title, body: @submission.body }}
